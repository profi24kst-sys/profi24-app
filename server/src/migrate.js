...
import {equipmentPickupStatements} from './equipment-pickup-schema.js';
...
export async function migrateCore(pool) {
  ...
  for(const sql of equipmentPickupStatements) await pool.query(sql);

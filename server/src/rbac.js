...
export const PERMISSIONS=Object.freeze({
  ...
  PAYROLL_SUMMARY_VIEW:'payroll.summary.view',
  PAYROLL_SELF_VIEW:'payroll.self.view',
  KPI_VIEW_ALL:'kpi.view.all',
  KPI_VIEW_SELF:'kpi.view.self',
...
const ROLE_PERMISSION_MAP=Object.freeze({
  ...
  SUPERVISOR:new Set([
    ...
    P.DIRECTORY_DELETED_LOOKUP,P.ENGINEER_PERFORMANCE_VIEW,P.KNOWLEDGE_VIEW,P.KNOWLEDGE_MANAGE
  ]),
  ACCOUNTANT:new Set([
    ...
    P.WAREHOUSE_VIEW,P.PROCUREMENT_VIEW,P.BRANCHES_VIEW,
    P.PAYROLL_VIEW,P.PAYROLL_MANAGE,P.PAYROLL_SUMMARY_VIEW,P.KPI_VIEW_ALL
  ]),
  MANAGER:new Set([
    P.ORDERS_VIEW_ALL,P.ORDERS_CREATE,P.ORDERS_ASSIGN,P.ORDERS_EDIT,P.ORDERS_TECHNICAL,P.ORDERS_NOTES,P.ORDERS_FILES,P.ORDERS_CLOSE,P.ORDERS_CANCEL,
    ...
    P.PAYROLL_SELF_VIEW,P.KPI_VIEW_SELF,
    P.OPERATIONS_MANAGE,P.COMMUNICATIONS_MANAGE,P.APPROVALS_MANAGE,P.DIRECTORY_DELETED_LOOKUP,P.ENGINEER_PERFORMANCE_VIEW,P.KNOWLEDGE_VIEW
  ]),
  ENGINEER:new Set([
    P.ORDERS_VIEW_ASSIGNED,P.ORDERS_TECHNICAL,P.ORDERS_NOTES,P.ORDERS_FILES,P.APPROVALS_MANAGE,P.BRANCHES_VIEW,
    P.PAYROLL_SELF_VIEW,P.KPI_VIEW_SELF,P.KNOWLEDGE_VIEW
  ]),
  TRAINEE:new Set([
    P.ORDERS_VIEW_ASSIGNED,P.ORDERS_NOTES,P.ORDERS_FILES,P.BRANCHES_VIEW,P.PAYROLL_SELF_VIEW,P.KNOWLEDGE_VIEW
  ])
});

...
export async function migrateFinance(pool) {
  ...
  try {
    ...
    const migrations=['001-auditable-accounts','002-part-returns-and-close-guard','003-payment-refunds-and-safe-cancellation','004-order-integrity','005-branches-and-cash-shifts','006-branch-guard-compat'];

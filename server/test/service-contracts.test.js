...
test('service contract creates reminders, respects branches and advances only after closed maintenance order',async()=>{
 ...
 await query('DELETE FROM user_branches WHERE user_id=5');await query('UPDATE users SET primary_branch_id=$1 WHERE id=5',[alt]);await query('INSERT INTO user_branches(user_id,branch_id,is_primary) VALUES(5,$1,true)',[alt]);

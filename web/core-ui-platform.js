// PROFI24 Core UI v1.2.1 — stable central navigation registry.
(function(){
  const groups={
  ...
  const state={nav:null,observer:null,scheduled:false,registry:new Map(),seq:0,ready:false,rebuilding:false};
